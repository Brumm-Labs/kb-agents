...
# ///
"""
First Breath — Deterministic sanctum scaffolding for agent-kb-linter.
...
def generate_capabilities_md(capabilities: list[dict], evolvable: bool) -> str:
    ...
    if evolvable:
        lines.extend([
            ...
            'Tell me "I want you to be able to check X" and we\'ll create it together.',
            "I'll write the check, save it to `capabilities/`, and register it here.",
...
def main():
    parser = argparse.ArgumentParser(
        description=f"First Breath scaffolding for {SKILL_NAME}"
    )
    ...
    result = {
        ...
        "templates_created": [t.replace("-template", "").upper()[:-3] + ".md" for t in TEMPLATE_FILES],
