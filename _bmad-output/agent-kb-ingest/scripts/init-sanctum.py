...
# ///
"""
First Breath — Deterministic sanctum scaffolding for agent-kb-ingest.

Creates the sanctum folder structure, copies template files with config
values substituted, copies capability references into the sanctum, and
